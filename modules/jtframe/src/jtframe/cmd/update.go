...
`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		if up_all {
			...
			up_cfg.Targets["mist_neptuno2"] = true			
...
func init() {
	...
	flag.StringSliceVarP( &up_targets, "target","t",[]string{"mist","sidi","sidi128","mist_neptuno2","mister","pocket"}, "Comma separated list of targets" )
